...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { description: @proyecto.description, image: @proyecto.image, lenguage: @proyecto.lenguage, link: @proyecto.link, name: @proyecto.name }
    end
  ...
  test "should update proyecto" do
    put :update, id: @proyecto, proyecto: { description: @proyecto.description, image: @proyecto.image, lenguage: @proyecto.lenguage, link: @proyecto.link, name: @proyecto.name }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
